...
func (self *Collector) Collect(ch chan<- prometheus.Metric) {
	...
	ch <- prometheus.MustNewConstMetric(self.SyncerBlocksBehind, prometheus.GaugeValue, float64(self.monitor.Report.BlockMonitor.State.SyncerBlocksBehind.Load()))
	ch <- prometheus.MustNewConstMetric(self.SyncerCurrentHeight, prometheus.GaugeValue, float64(self.monitor.Report.BlockMonitor.State.SyncerCurrentHeight.Load()))
	...
	ch <- prometheus.MustNewConstMetric(self.AverageBlocksProcessedPerMinute, prometheus.GaugeValue, float64(self.monitor.Report.BlockMonitor.State.AverageBlocksProcessedPerMinute.Load()))
	ch <- prometheus.MustNewConstMetric(self.AverageTransactionDownloadedPerMinute, prometheus.GaugeValue, float64(self.monitor.Report.BlockMonitor.State.AverageTransactionDownloadedPerMinute.Load()))
	...
	ch <- prometheus.MustNewConstMetric(self.TransactionsDownloaded, prometheus.CounterValue, float64(self.monitor.Report.BlockMonitor.State.TransactionsDownloaded.Load()))
	...
	ch <- prometheus.MustNewConstMetric(self.TxDownloadErrors, prometheus.CounterValue, float64(self.monitor.Report.BlockMonitor.Errors.TxDownloadErrors.Load()))
	ch <- prometheus.MustNewConstMetric(self.BlockValidationErrors, prometheus.CounterValue, float64(self.monitor.Report.BlockMonitor.Errors.BlockValidationErrors.Load()))
	ch <- prometheus.MustNewConstMetric(self.BlockDownloadErrors, prometheus.CounterValue, float64(self.monitor.Report.BlockMonitor.Errors.BlockDownloadErrors.Load()))

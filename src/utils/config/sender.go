...
func setSenderDefaults() {
	...
	viper.SetDefault("Bundler.StoreBatchSize", "100")
	viper.SetDefault("Bundler.StoreInterval", "1s")
	viper.SetDefault("Bundler.StoreBackoffMaxElapsedTime", "0")
	viper.SetDefault("Bundler.StoreBackoffMaxInterval", "8s")
}
